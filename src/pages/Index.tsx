...
<p className="text-xl md:text-2xl text-white/60 max-w-2xl mx-auto leading-relaxed animate-fade-up delay-200">
...
<p className="text-white/50 text-sm">&copy; 2025 Slate AI. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );

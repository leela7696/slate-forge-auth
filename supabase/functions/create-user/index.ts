...
serve(async (req) => {
  ...
  try {
    ...
    const hasPermission = await checkPermission(supabaseAdmin, payload.userId, 'User Management', 'create');
    ...
    await createUserNotification(supabaseAdmin, newUser.id, 'USER_CREATED', {});
